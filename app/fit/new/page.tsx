...
const INPUT_CLS = "w-full rounded-md border border-gsgl-navy/20 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gsgl-gold/50";
const SELECT_CLS = "w-full rounded-md border border-gsgl-navy/20 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gsgl-gold/50";
      ...
      <div className="mt-8">
        {step === 0 && (
          <FormSectionWrapper title="Player Profile" description="Capture baseline inputs and tendencies.">
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <label className="block text-xs font-medium text-gsgl-navy mb-1" htmlFor="handicap">Handicap (0–54)</label>
              ...
              <div>
                <label className="block text-xs font-medium text-gsgl-navy mb-1" htmlFor="heightIn">Height (inches)</label>
              ...
              <div>
                <label className="block text-xs font-medium text-gsgl-navy mb-1" htmlFor="wristToFloorIn">Wrist-to-floor (inches)</label>
              ...
              <div>
                <label className="block text-xs font-medium text-gsgl-navy mb-1" htmlFor="ageRange">Age range</label>
              ...
              <div>
                <label className="block text-xs font-medium text-gsgl-navy mb-1" htmlFor="tempo">Swing tempo</label>
              ...
              <div>
                <label className="block text-xs font-medium text-gsgl-navy mb-1" htmlFor="missTendency">Common miss</label>
              ...
              <div className="md:col-span-2">
                <label className="block text-xs font-medium text-gsgl-navy mb-1" htmlFor="trajectory">Preferred trajectory</label>
        ...
        {step === 1 && (
          <FormSectionWrapper title="Current Equipment" description="Document your current bag setup.">
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <label className="block text-xs font-medium text-gsgl-navy mb-1" htmlFor="driverModel">Driver model</label>
              ...
              <div>
                <label className="block text-xs font-medium text-gsgl-navy mb-1" htmlFor="driverLoft">Driver loft</label>
              ...
              <div>
                <label className="block text-xs font-medium text-gsgl-navy mb-1" htmlFor="driverShaft">Driver shaft</label>
              ...
              <div>
                <label className="block text-xs font-medium text-gsgl-navy mb-1" htmlFor="ballModel">Ball model</label>
              ...
              <div>
                <label className="block text-xs font-medium text-gsgl-navy mb-1" htmlFor="ironModel">Iron model</label>
              ...
              <div>
                <label className="block text-xs font-medium text-gsgl-navy mb-1" htmlFor="ironShaft">Iron shaft</label>
          ...
          <FormSectionWrapper title="Launch Data" description="Add monitor metrics used in scoring and confidence calculations. All fields optional.">
            <div className="grid gap-4 md:grid-cols-3">
              {[
                ...
                <div key={id}>
                  <label className="block text-xs font-medium text-gsgl-navy mb-1" htmlFor={id}>{label}</label>
          ...
          <FormSectionWrapper title="Goals" description="Choose the outcomes that should carry the most weight.">
            <div className="grid gap-3 sm:grid-cols-2">
              {([
                ...
                <label key={id} htmlFor={id} className="flex items-center gap-3 rounded-md border border-gsgl-navy/15 bg-gsgl-offwhite px-4 py-3 text-sm text-gsgl-navy cursor-pointer">
        ...
        {step === 4 && (
          <FormSectionWrapper title="Review" description="Confirm inputs before generating recommendations.">
            <dl className="grid gap-3 sm:grid-cols-2 text-sm">
              <div className="rounded-lg border border-gsgl-navy/10 bg-white p-4">
                <dt className="font-semibold text-gsgl-navy mb-1">Player Profile</dt>
                <dd className="text-gsgl-gray space-y-0.5">
              ...
              <div className="rounded-lg border border-gsgl-navy/10 bg-white p-4">
                <dt className="font-semibold text-gsgl-navy mb-1">Current Equipment</dt>
                <dd className="text-gsgl-gray space-y-0.5">
              ...
              <div className="rounded-lg border border-gsgl-navy/10 bg-white p-4">
                <dt className="font-semibold text-gsgl-navy mb-1">Launch Data</dt>
                <dd className="text-gsgl-gray space-y-0.5">
              ...
              <div className="rounded-lg border border-gsgl-navy/10 bg-white p-4">
                <dt className="font-semibold text-gsgl-navy mb-1">Goals</dt>
                <dd className="text-gsgl-gray">
